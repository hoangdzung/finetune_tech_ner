...
model.train()
if args.encode_format == 'BILUO':
    converter = offset_to_biluo
elif args.encode_format == 'BIO':
    converter = offset_to_bio
else:
    raise NotImplementedError

train_texts, train_tags = converter(args.train_data)
print("There are {} sentences in the train dataset".format(len(train_tags)))
test_texts, test_tags = converter(args.test_data)
